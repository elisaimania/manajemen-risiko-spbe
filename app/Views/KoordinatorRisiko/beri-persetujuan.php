    ...
    <div class="card-body ">
        ...
        <div class="form-group">
            <form class="user" method="post" action="">
                ...
                <div class="col mt-5">
                    <?php if($sublink!=''): ?>
                    <a href="<?= base_url('KoordinatorRisiko/'.$sublink); ?>" class="btn  btn-secondary float-right m-3" style="width: 120px; height: 40px;">Batal</a>
                    <?php else: ?>
                    <a href="<?= base_url('KoordinatorRisiko/'.$link); ?>" class="btn  btn-secondary float-right m-3" style="width: 120px; height: 40px;">Batal</a>
                    <?php endif; ?>
