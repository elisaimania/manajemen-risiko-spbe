...
@media (max-width: 768px){
 ...
 <ul class="navbar-nav  sidebar sidebar-dark accordion nav-pills" id="accordionSidebar" style="background-color: #8CBA08;" >
    ...
    <!-- Sidebar - Brand -->
    <a class="sidebar-brand d-flex align-items-center justify-content-center my-4" href="<?= base_url('koordinatorRisiko/dashboard'); ?>">
    ...
    <li class="nav-item <?= ($active==='Dashboard') ? 'active' : ''; ?>">
        <a class="nav-link " href="<?= base_url('koordinatorRisiko/dashboard'); ?>" >
