...
<div class="card shadow  m-5  col-sm-8 ">
    <div class="card-body ">
        ...
        <div class="form-group">
        	<form class="user" method="post" action="<?= base_url('admin/inputOpsiPenanganan') ?>">
                <div class="form-group row">
                    <div class="col">
                    	<label for="opsi_penanganan">Opsi Penanganan Risiko SPBE</label>
                    	<input type="text" class="form-control" id="opsi_penanganan" name="opsi_penanganan" required>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="col">
                	<a href="<?= base_url('admin/daftarPenanganan'); ?>" class="btn  btn-secondary float-right m-3" style="border-radius: 30px; width: 120px; height: 40px;">Batal</a>
