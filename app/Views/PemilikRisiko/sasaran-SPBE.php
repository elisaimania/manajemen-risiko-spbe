    ...
    <div class="card-body">
        <div class="form-group">
             <div class="row">
                ...
                <div class="col">
                    <a href="<?= base_url('PemilikRisiko/inputSasaranSPBE'); ?>" class="btn float-right" >Tambah Data</a>
                    <a href="<?= base_url('PemilikRisiko/importSasaranSPBE'); ?>" class="btn float-right mr-3" >Import Excel</a>
                </div>
            </div>
        </div>
