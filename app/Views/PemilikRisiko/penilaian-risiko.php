    ...
    <div class="card-body">
        <div class="form-group">
             <div class="row">
                ...
                <div class="col">
                    <a href="<?= base_url('PemilikRisiko/inputPenilaianRisiko'); ?>" class="btn float-right" >Tambah</a>
                    <a href="<?= base_url('PemilikRisiko/importPenilaianRisiko'); ?>" class="btn float-right mr-3" >Import Excel</a>
                </div>
            </div>
        </div>
