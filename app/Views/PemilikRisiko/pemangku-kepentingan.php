    ...
    <div class="card-body">
        <div class="form-group">
             <div class="row">
                ...
                <div class="col">
                    <a href="<?= base_url('PemilikRisiko/inputPemangkuKepentingan'); ?>" class="btn float-right" >Tambah Data</a>
                    <a href="<?= base_url('PemilikRisiko/importPemangkuKepentingan'); ?>" class="btn float-right mr-3" >Import Excel</a>
                </div>
            </div>
        </div>
