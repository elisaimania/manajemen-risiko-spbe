        	...
        	<form class="user" method="post" action="">
                <div class="form-group row">
                    <div class="col">
                    	...
                    	<textarea type="text" class="form-control" id="sasaran_UPR_SPBE" name="sasaran_UPR_SPBE" required ></textarea>
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col">
                        <label for="sasaran_SPBE">Sasaran SPBE</label>
                        <textarea  class="form-control" id="sasaran_SPBE" name="sasaran_SPBE" required></textarea> 
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col">
                        <label for="indikator_kinerja_SPBE">Indikator Kinerja SPBE</label>
                        <input  class="form-control" id="indikator_kinerja_SPBE" name="indikator_kinerja_SPBE" required>
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col">
                        <label for="target_kinerja">Target Kierja SPBE</label>
                        <input  class="form-control" id="target_kinerja" name="target_kinerja" required>
                    </div>
                </div>
                <div class="col mt-5">
                </div>
                <div class="col mt-5">
                	<a href="<?= base_url('pengelolaRisiko/sasaranSPBE'); ?>" class="btn  btn-secondary float-right m-3" style="border-radius: 30px; width: 120px; height: 40px;">Batal</a>
