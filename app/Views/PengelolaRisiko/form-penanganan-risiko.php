            ...
            <form class="user" method="post" action="">
                <div class="form-group">
                    <div class="col">
                        ...
                        <div class="row">
                            ...
                            <a href="<?= base_url('pengelolaRisiko/pilihRisiko'); ?>" type="button" class="btn btn-secondary cols-sm-3 ml-3" style="border-radius: 30px;">Ganti</a>
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <select class="form-control" id="opsi_penanganan" name="opsi_penanganan" required>
                        ...
                        <?php foreach ($daftarOpsiPenanganan as $r ) : ?>
                            <option value="<?= $r['opsi_penanganan']; ?>" <?= ( old('opsi_penanganan')==$r['opsi_penanganan']) ? 'selected' : ''; ?>><?= $r['opsi_penanganan']; ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
                ...
                <div class="form-group row">
                    <div class="col-sm-5 mb-3 mb-sm-0">
                        ...
                        <input type="date" class="form-control" id="jadwal" name="jadwal_mulai" required value="<?= old('jadwal_mulai'); ?>">
                    </div>
                    ...
                    <div class="col-sm-5">
                        ...
                        <input type="date" class="form-control" id="jadwal" name="jadwal_selesai" required value="<?= old('jadwal_selesai'); ?>">
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col">
