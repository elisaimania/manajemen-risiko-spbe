    ...
    <div class="card-body">
        <div class="form-group">
             <div class="row">
                ...
                <div class="col">
                    <a href="<?= base_url('pengelolaRisiko/pilihRisikoPemantauan'); ?>" class="btn float-right hijau" >Tambah</a>
                    <a href="<?= base_url('pengelolaRisiko/importPemantauanRisiko'); ?>" class="btn float-right mr-3 hijau" >Import Excel</a>
                    <a href="<?= base_url('pengelolaRisiko/hapusPemantauanRisiko'); ?>" class="btn btn-danger float-right mr-3" onclick="return confirm('Apakah Anda yakin untuk menghapus semua data ini?')">Hapus Semua Data</a>
                </div>
            </div>
        </div>
