...
class KategoriRisikoTerpilihModel extends Model
{
    ...
    public function getKategoriRisikoTerpilih(){
        ...
        return $this->builder()->select('kategori_risiko_spbe_terpilih.id, id_kategori_risiko, kategori_risiko_spbe.kategori_risiko, id_upr, id_status_persetujuan, status_persetujuan.status, komentar')->where('id_upr',session()->id_upr)->get()->getResultArray();
