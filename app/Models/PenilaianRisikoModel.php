...
class PenilaianRisikoModel extends Model
{
    ...
    public function getpenilaianBelumSetuju(){
    ...
    public function getPenilaian()
    {
        ...
        level_kemungkinan_risiko_spbe.level_kemungkinan, level_dampak_risiko_spbe.level_dampak, penilaian_risiko_spbe.id_upr, kriteria_kemungkinan_risiko_spbe.id_status_persetujuan, kriteria_dampak_risiko_spbe.id_status_persetujuan,
            CASE 
                WHEN id_keputusan = 2 
                THEN DENSE_RANK() OVER (ORDER BY besaran_risiko DESC) ELSE ''
            END AS prioritas
            ...
            " AND kriteria_kemungkinan_risiko_spbe.id_status_persetujuan = 2 AND kriteria_dampak_risiko_spbe.id_status_persetujuan = 2 AND kategori_risiko_spbe_terpilih.id_status_persetujuan = 2 AND area_dampak_risiko_spbe_terpilih.id_status_persetujuan
             = 2 AND sasaran_spbe.id_status_persetujuan = 2
             ORDER BY besaran_risiko DESC
            ";
        return $db->query($query)->getResultArray();
    }
    ...
    public function getPenilaianByKeputusan()
    {
        ...
        level_kemungkinan_risiko_spbe.level_kemungkinan, level_dampak_risiko_spbe.level_dampak, penilaian_risiko_spbe.id_upr,
            ...
            ON kriteria_dampak_risiko_spbe.id_area_dampak = penilaian_risiko_spbe.id_area_dampak AND
            kriteria_dampak_risiko_spbe.id_level_dampak = penilaian_risiko_spbe.id_level_dampak AND
            kriteria_dampak_risiko_spbe.id_jenis_risiko = penilaian_risiko_spbe.id_jenis_risiko AND kriteria_dampak_risiko_spbe.id_upr = kriteria_dampak_risiko_spbe.id_upr
            INNER JOIN level_risiko_spbe
            ON level_risiko_spbe.id = penilaian_risiko_spbe.id_level_risiko
            INNER JOIN keputusan
            ON keputusan.id = penilaian_risiko_spbe.id_keputusan
            WHERE id_keputusan =2 AND penilaian_risiko_spbe.id NOT IN (
                                                                        SELECT id_risiko FROM rencana_penanganan_risiko_spbe WHERE id_status_persetujuan = 2 OR id_status_persetujuan = 1) AND penilaian_risiko_spbe.id_upr = " . session()->id_upr.
            " AND penilaian_risiko_spbe.id_status_persetujuan = 2 AND kriteria_kemungkinan_risiko_spbe.id_status_persetujuan = 2 AND kriteria_dampak_risiko_spbe.id_status_persetujuan = 2 AND kategori_risiko_spbe_terpilih.id_status_persetujuan = 2 AND area_dampak_risiko_spbe_terpilih.id_status_persetujuan = 2 AND sasaran_spbe.id_status_persetujuan = 2
             ORDER BY besaran_risiko DESC
            ";
        return $db->query($query)->getResultArray();
    }
    ...
    public function getPenilaianByPenanganan()
    {
        ...
        level_kemungkinan_risiko_spbe.level_kemungkinan, level_dampak_risiko_spbe.level_dampak, penilaian_risiko_spbe.id_upr,
            ...
            INNER JOIN keputusan
            ON keputusan.id = penilaian_risiko_spbe.id_keputusan
            WHERE id_keputusan =2 AND penilaian_risiko_spbe.id IN (
                                                                        SELECT id_risiko FROM rencana_penanganan_risiko_spbe WHERE id_status_persetujuan = 2 ) AND penilaian_risiko_spbe.id_upr = " . session()->id_upr.
            " AND penilaian_risiko_spbe.id_status_persetujuan = 2 AND kriteria_kemungkinan_risiko_spbe.id_status_persetujuan = 2 AND kriteria_dampak_risiko_spbe.id_status_persetujuan = 2 AND kategori_risiko_spbe_terpilih.id_status_persetujuan = 2 AND area_dampak_risiko_spbe_terpilih.id_status_persetujuan = 2 AND sasaran_spbe.id_status_persetujuan = 2
             ORDER BY besaran_risiko DESC
            ";
        return $db->query($query)->getResultArray();
    ...
    public function getPenilaianSetuju()
    {
        ...
        $query = "SELECT penilaian_risiko_spbe.id, id_sasaran_SPBE, penilaian_risiko_spbe.id_jenis_risiko, kejadian, penyebab, penilaian_risiko_spbe.id_kategori_risiko, dampak, penilaian_risiko_spbe.id_area_dampak, sistem_pengendalian, penilaian_risiko_spbe.id_level_kemungkinan, penilaian_risiko_spbe.id_level_dampak, penilaian_risiko_spbe.id_level_risiko, id_keputusan, penilaian_risiko_spbe.id_status_persetujuan, status_persetujuan.status, penilaian_risiko_spbe.komentar, sasaran_spbe.sasaran_SPBE, sasaran_spbe.indikator_kinerja_SPBE, jenis_risiko.jenis_risiko, kategori_risiko_spbe.kategori_risiko, area_dampak_risiko_spbe.area_dampak, matriks_analisi_risiko.besaran_risiko, level_risiko_spbe.level_risiko, keputusan.keputusan, kriteria_dampak_risiko_spbe.penjelasan, kriteria_kemungkinan_risiko_spbe.presentase_kemungkinan, level_kemungkinan_risiko_spbe.level_kemungkinan, level_dampak_risiko_spbe.level_dampak,
            ...
            INNER JOIN keputusan
            ON keputusan.id = penilaian_risiko_spbe.id_keputusan
            WHERE penilaian_risiko_spbe.id_status_persetujuan = 2 AND kriteria_kemungkinan_risiko_spbe.id_status_persetujuan = 2 AND kriteria_dampak_risiko_spbe.id_status_persetujuan=2 AND kategori_risiko_spbe_terpilih.id_status_persetujuan = 2 AND area_dampak_risiko_spbe_terpilih.id_status_persetujuan = 2 AND sasaran_spbe.id_status_persetujuan = 2 AND penilaian_risiko_spbe.id_upr = " . session()->id_upr.
            " ORDER BY besaran_risiko DESC
            ";
        return $db->query($query)->getResultArray();
