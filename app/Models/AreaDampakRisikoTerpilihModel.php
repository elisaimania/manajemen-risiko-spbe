...
class AreaDampakRisikoTerpilihModel extends Model
{
    ...
    public function getAreaDampakRisikoTerpilih(){
        ...
        return $this->builder()->select('area_dampak_risiko_spbe_terpilih.id, id_area_dampak, area_dampak_risiko_spbe.area_dampak, id_upr, id_status_persetujuan, status_persetujuan.status, komentar')->orderBy('id_status_persetujuan', 'DESC')->where('id_upr',session()->id_upr)->get()->getResultArray();
