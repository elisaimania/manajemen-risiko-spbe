...
class KriteriaKemungkinanModel extends Model
{
    ...
    protected $allowedFields =['id','id_kategori_risiko','id_level_kemungkinan','presentase_kemungkinan', 'id_upr', 'id_status_persetujuan','komentar', 'jumlah_frekuensi'];
    ...
    public function getKriteriaKemungkinan(){
        ...
        return $this->builder()->select('kriteria_kemungkinan_risiko_spbe.id, id_kategori_risiko, id_level_kemungkinan, level_kemungkinan_risiko_spbe.level_kemungkinan, kategori_risiko_spbe.kategori_risiko, id_upr, id_status_persetujuan, status_persetujuan.status,komentar, presentase_kemungkinan, jumlah_frekuensi')->get()->getResultArray();
