...
// //                     </td>
// //                     <td>
// //                         <a href="updatePemantauanRisiko/${d.id}" type="button" class="badge badge-success" style="color: #fff; background-color:#8CBA08; border:none">Edit</a>
// //                         <a href="hapusPemantauanRisiko/${d.id}" type="button" class="badge badge-danger" style="border:none" onclick="return confirm('Apakah Anda yakin untuk menghapus data ini?')">Hapus</a>
// //                         <a href="detailPersetujuanPemantauanRisiko/${d.id}" type="button" class="badge badge-primary">Detail Persetujuan</a>
// //                     </td>
// //                     <td>
// //                         <a href="detailRisikoPemantauan/${d.id_risiko}" class="font-weight-bold" id="id_risiko">${'ID_'+d.id_risiko}</a>
// //                     </td>
// //                     <td>
// //                         <a href="detailPenanganan/${d.id_penanganan_risiko}" class="font-weight-bold" id="id_risiko">${'ID_'+d.id_risiko}</a>
// //                     </td>
// //                     <td>
// //                         ${d.jenis_laporan}
// //                     </td>
...
// // function loadDataPilihRisikoPemantauan() {
// //     $.get('getRisikoByPenanganan', (data) => {
...
// //                     </td>
// //                     <td>
// //                         <a href="pilihJenisLaporan/${d.id}" type="button" class="badge badge-success" style="color: #fff; background-color:#8CBA08; border:none">Pilih</a>
// //                     </td>
// //                     <td>
// //                         <a href="detailRisiko/${d.id}" class="font-weight-bold">${'ID_'+d.id}</a>
// //                     </td>
...
// //         });
// //         tbody = `<tbody>${cell}</tbody>`
// //         table = `<table id="table20" class="table table-bordered" style="width:100%;">
// //         ${thead}
// //         ${tbody}
// //         </table>`

// //         $('#tabel-pilihRisikoPemantauan').html(table)
// //         $("#table20").DataTable({
// //             "responsive": true, "lengthChange": false, "autoWidth": false
// //         });
// //     })
