    ...
    $.get('getDaftarKriteriaKemungkinan/', (data) => {
        ...
        data.forEach(d => {
            cell+=`
                <tr>
                     <td>
                        <a href="beriPersetujuanKriteriaKemungkinan/${d.id_kategori_risiko}" type="button" class="badge badge-success" style="color: #fff; background-color:#8CBA08; border:none">Beri Persetujuan</a>
                    </td>
                    <td>
                        ${d.status}
                    </td>
    ...
    $.get('getDaftarKriteriaDampak/', (data) => {
        ...
        data.forEach(d => {
            cell+=`
                <tr>
                    <td>
                        <a href="beriPersetujuanKriteriaDampak/${d.id_area_dampak}" type="button" class="badge badge-success" style="color: #fff; background-color:#8CBA08; border:none">Beri Persetujuan</a>
                    </td>
                    <td>
                        ${d.status}
                    </td>
        ...
        data.forEach(d => {
            cell+=`
                <tr>
                    ...
                    <td>
                        <a href="beriPersetujuanSeleraRisiko/${d.id_kategori_risiko}" type="button" class="badge badge-success" style="color: #fff; background-color:#8CBA08; border:none">Beri Persetujuan</a>
                    </td>
...
function loadDataAnalisisRisiko() {
    $.get('getPenilaianRisiko', (data) => {
        ...
        $("#table15").DataTable({
            "responsive": true, "lengthChange": false, "autoWidth": false,
            "buttons": ["csv", "excel", "pdf"], "order" :[[2,'DESC']]
