    ...
    $.get('getDaftarKriteriaKemungkinan/', (data) => {
        ...
        data.forEach(d => {
            cell+=`
                <tr>
                     <td>
                        <a href="beriPersetujuanKriteriaKemungkinan/${d.id_kategori_risiko}/${d.tag}" type="button" class="badge badge-success" style="color: #fff; background-color:#8CBA08; border:none">Beri Persetujuan</a>
                    </td>
                    <td>
                        ${d.status}
                    </td>
    ...
    $.get('getDaftarKriteriaDampak/', (data) => {
        ...
        data.forEach(d => {
            cell+=`
                <tr>
                    <td>
                        <a href="beriPersetujuanKriteriaDampak/${d.id_area_dampak}/${d.tag}" type="button" class="badge badge-success" style="color: #fff; background-color:#8CBA08; border:none">Beri Persetujuan</a>
                    </td>
                    <td>
                        ${d.status}
                    </td>
