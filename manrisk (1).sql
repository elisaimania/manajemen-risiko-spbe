...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 10, 2022 at 08:01 AM
...
--
-- Table structure for table `area_dampak_risiko_spbe`
--
...
--
-- Dumping data for table `area_dampak_risiko_spbe`
--
...
--
-- Table structure for table `area_dampak_risiko_spbe_terpilih`
--
...
--
-- Table structure for table `jenis_risiko`
--
...
--
-- Dumping data for table `jenis_risiko`
--
...
--
-- Table structure for table `kategori_risiko_spbe`
--
...
--
-- Dumping data for table `kategori_risiko_spbe`
--
...
--
-- Table structure for table `kategori_risiko_spbe_terpilih`
--
...
--
-- Table structure for table `kriteria_dampak_risiko_spbe`
--
...
--
-- Table structure for table `kriteria_kemungkinan_risiko_spbe`
--
...
--
-- Table structure for table `level_dampak_risiko_spbe`
--
...
--
-- Dumping data for table `level_dampak_risiko_spbe`
--
...
--
-- Table structure for table `level_kemungkinan_risiko_spbe`
--
...
--
-- Dumping data for table `level_kemungkinan_risiko_spbe`
--
...
--
-- Table structure for table `level_risiko_spbe`
--
...
--
-- Dumping data for table `level_risiko_spbe`
--
...
--
-- Table structure for table `matriks_analisi_risiko`
--
...
--
-- Dumping data for table `matriks_analisi_risiko`
--
...
--
-- Table structure for table `opsi_penanganan_risiko_spbe`
--
...
--
-- Dumping data for table `opsi_penanganan_risiko_spbe`
--
...
--
-- Table structure for table `pemantauan_risiko_spbe`
--
...
INSERT INTO `pengguna` (`id`, `id_role`, `nama_pengguna`, `username`, `password`, `email`, `id_upr`) VALUES
(1, 1, 'Elisa Imania', 'els12', '$2y$10$/1ALTKRt7F6UYxcNOFoN2ePeqA3RIS2bAEfWOx82KGhhVqJ8w3FgK', 'elisaimania123@gmail.com', 1),
(2, 1, 'Elisa Imania', 'els13', '$2y$10$/1ALTKRt7F6UYxcNOFoN2ePeqA3RIS2bAEfWOx82KGhhVqJ8w3FgK', 'elisaimania123@gmail.com', 2),
(3, 4, 'Elisa Imania', 'elisa', '$2y$10$/1ALTKRt7F6UYxcNOFoN2ePeqA3RIS2bAEfWOx82KGhhVqJ8w3FgK', 'elisaimania123@gmail.com', 1),
(9, 2, 'Elisa Imania', 'els14', '$2y$10$HA8lW1dslJ8rTM38DhOLJ.RjIWooe9YHYTCYtlBjkSca9VjPNjxnO', '221810261@stis.ac.id', 1),
(10, 3, 'Elisa Imania', 'els15', '$2y$10$5Hui4z8R5SSZL26Y1FkRh.Hc2O6nZmI6AaYaPPaRMn/his42BN.Ee', '221810200@stis.ac.id', 1),
(13, 2, 'Elisa Imania', 'els17', '$2y$10$6H9i13N64G8vWxeoKeNh/OCURa/jw93Jggsi1yzO9WxdBMV/mvPNS', '', 2),
(14, 3, 'Erik Rihendri Chandra', 'erik', '$2y$10$iG6QGRlSappzgMqZv0JqtepfiJjQZWaq2UHLLT7xJ64nHnckitzFK', 'bisa@gmail.com', 2);

-- --------------------------------------------------------

--
-- Table structure for table `penilaian_risiko_spbe`
--
...
--
-- Table structure for table `peraturan_perundangan`
--
...
--
-- Table structure for table `rencana_penanganan_risiko_spbe`
--
...
--
-- Table structure for table `sasaran_spbe`
--
...
--
-- Table structure for table `selera_risiko_spbe`
--
...
--
-- Table structure for table `struktur_pelaksana`
--
...
--
-- Table structure for table `upr_spbe`
--
...
--
-- Dumping data for table `upr_spbe`
--
...
--
-- Indexes for table `area_dampak_risiko_spbe`
--
ALTER TABLE `area_dampak_risiko_spbe`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `area_dampak_risiko_spbe_terpilih`
--
...
--
-- Indexes for table `jenis_risiko`
--
ALTER TABLE `jenis_risiko`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `kategori_risiko_spbe`
--
ALTER TABLE `kategori_risiko_spbe`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `kategori_risiko_spbe_terpilih`
--
...
--
-- Indexes for table `kriteria_dampak_risiko_spbe`
--
...
--
-- Indexes for table `kriteria_kemungkinan_risiko_spbe`
--
...
--
-- Indexes for table `level_dampak_risiko_spbe`
--
ALTER TABLE `level_dampak_risiko_spbe`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `level_kemungkinan_risiko_spbe`
--
ALTER TABLE `level_kemungkinan_risiko_spbe`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `level_risiko_spbe`
--
ALTER TABLE `level_risiko_spbe`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `matriks_analisi_risiko`
--
...
--
-- Indexes for table `opsi_penanganan_risiko_spbe`
--
...
--
-- Indexes for table `pemantauan_risiko_spbe`
--
...
--
-- Indexes for table `penilaian_risiko_spbe`
--
...
--
-- Indexes for table `peraturan_perundangan`
--
...
--
-- Indexes for table `rencana_penanganan_risiko_spbe`
--
...
--
-- Indexes for table `sasaran_spbe`
--
...
--
-- Indexes for table `selera_risiko_spbe`
--
...
--
-- Indexes for table `struktur_pelaksana`
--
...
--
-- AUTO_INCREMENT for table `area_dampak_risiko_spbe`
--
ALTER TABLE `area_dampak_risiko_spbe`
  MODIFY `id` int(4) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `area_dampak_risiko_spbe_terpilih`
--
ALTER TABLE `area_dampak_risiko_spbe_terpilih`
...
--
-- AUTO_INCREMENT for table `kategori_risiko_spbe`
--
ALTER TABLE `kategori_risiko_spbe`
  MODIFY `id` int(4) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT for table `kategori_risiko_spbe_terpilih`
--
ALTER TABLE `kategori_risiko_spbe_terpilih`
  MODIFY `id` int(4) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `kriteria_dampak_risiko_spbe`
--
ALTER TABLE `kriteria_dampak_risiko_spbe`
  MODIFY `id` int(4) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `kriteria_kemungkinan_risiko_spbe`
--
ALTER TABLE `kriteria_kemungkinan_risiko_spbe`
  MODIFY `id` int(4) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `level_risiko_spbe`
--
ALTER TABLE `level_risiko_spbe`
...
--
-- AUTO_INCREMENT for table `opsi_penanganan_risiko_spbe`
--
ALTER TABLE `opsi_penanganan_risiko_spbe`
...
--
-- AUTO_INCREMENT for table `pemantauan_risiko_spbe`
--
ALTER TABLE `pemantauan_risiko_spbe`
  MODIFY `id` int(4) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `penilaian_risiko_spbe`
--
ALTER TABLE `penilaian_risiko_spbe`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `peraturan_perundangan`
--
ALTER TABLE `peraturan_perundangan`
  MODIFY `id` int(4) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `rencana_penanganan_risiko_spbe`
--
ALTER TABLE `rencana_penanganan_risiko_spbe`
  MODIFY `id` int(4) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `sasaran_spbe`
--
ALTER TABLE `sasaran_spbe`
  MODIFY `id` int(4) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `selera_risiko_spbe`
--
ALTER TABLE `selera_risiko_spbe`
  MODIFY `id` int(4) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `struktur_pelaksana`
--
ALTER TABLE `struktur_pelaksana`
  MODIFY `id` int(4) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `upr_spbe`
--
ALTER TABLE `upr_spbe`
...
--
-- Constraints for table `area_dampak_risiko_spbe_terpilih`
--
ALTER TABLE `area_dampak_risiko_spbe_terpilih`
...
--
-- Constraints for table `informasi_umum`
--
ALTER TABLE `informasi_umum`
...
--
-- Constraints for table `kategori_risiko_spbe_terpilih`
--
ALTER TABLE `kategori_risiko_spbe_terpilih`
...
--
-- Constraints for table `kriteria_dampak_risiko_spbe`
--
ALTER TABLE `kriteria_dampak_risiko_spbe`
...
--
-- Constraints for table `kriteria_kemungkinan_risiko_spbe`
--
ALTER TABLE `kriteria_kemungkinan_risiko_spbe`
...
--
-- Constraints for table `matriks_analisi_risiko`
--
ALTER TABLE `matriks_analisi_risiko`
...
--
-- Constraints for table `opsi_penanganan_risiko_spbe`
--
ALTER TABLE `opsi_penanganan_risiko_spbe`
...
--
-- Constraints for table `pemangku_kepentingan`
--
ALTER TABLE `pemangku_kepentingan`
...
--
-- Constraints for table `pemantauan_risiko_spbe`
--
ALTER TABLE `pemantauan_risiko_spbe`
...
--
-- Constraints for table `penilaian_risiko_spbe`
--
ALTER TABLE `penilaian_risiko_spbe`
...
--
-- Constraints for table `peraturan_perundangan`
--
ALTER TABLE `peraturan_perundangan`
...
--
-- Constraints for table `rencana_penanganan_risiko_spbe`
--
ALTER TABLE `rencana_penanganan_risiko_spbe`
...
--
-- Constraints for table `sasaran_spbe`
--
ALTER TABLE `sasaran_spbe`
...
--
-- Constraints for table `selera_risiko_spbe`
--
ALTER TABLE `selera_risiko_spbe`
...
--
-- Constraints for table `struktur_pelaksana`
--
ALTER TABLE `struktur_pelaksana`
